...
const generateMember = (scope, decl, _global, _name) => {
  ...
  if (['size', 'description', 'byteLength', 'byteOffset', 'buffer', 'detached', 'resizable', 'maxByteLength'].includes(decl.property.name)) {
    const bc = {};
...
const objectHack = node => {
  ...
  if (node.type === 'MemberExpression') {
    const out = (() => {
      ...
      if (['name', 'length', 'size', 'description', 'byteLength', 'byteOffset', 'buffer', 'detached', 'resizable', 'maxByteLength'].includes(node.property.name)) {
