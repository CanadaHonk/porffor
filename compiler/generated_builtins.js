...
export const BuiltinFuncs = function() {
  this.__Array_isArray = {
    wasm: (scope, { allocPage, builtin }) => [[32,1],[65,16],[70]],
    params: [127,127],
    typedParams: true,
    returns: [127],
    returnType: 1,
