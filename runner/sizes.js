...
let csv = `file,porffor i32 -O0,porffor i32 -O1,porffor i32 -O2,porffor i32 -O3,porffor i64 -O0,porffor i64 -O1,porffor i64 -O2,porffor i64 -O3\n`;
...
const argsValtypes = [ '-valtype=i32', '-valtype=i64' ];
